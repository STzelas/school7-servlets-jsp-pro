...
public class StudentDAOImpl implements IStudentDAO{
    ...
    public Student insert(Student student) throws StudentDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            if (rsGeneratedKeys.next()) {
                ...
                insertStudent = getById(generateId);
            }
            return insertStudent;
        } catch (SQLException e) {
            throw new StudentDAOException("SQL error in student insert with email: " +
                    student.getEmail());
        }
    }
    ...
    public Student update(Student student) throws StudentDAOException {
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            throw new StudentDAOException("SQL error in student update with email: " +
                    student.getEmail());
        }
    }
    ...
    public Student getById(Integer id) throws StudentDAOException {
        ...
        try(Connection connection = DBUtil.getConnection();
            ...
            throw new StudentDAOException("SQL Error in getting student by id with id: " + id);
        }
    }
