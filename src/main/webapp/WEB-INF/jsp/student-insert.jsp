                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="firstname" name="firstname" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.firstname ? requestScope.insertStudentDTO.firstname : '')}"
                    ...
                    <div>
                        ...
                        <input id="lastname" name="lastname" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.lastname ? requestScope.insertStudentDTO.lastname : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="fathername" name="fathername" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.fatherName ? requestScope.insertStudentDTO.fatherName : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="phoneNum" name="phoneNum" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.phoneNum ? requestScope.insertStudentDTO.phoneNum : '')}"
                    ...
                    <div>
                        ...
                        <input id="email" name="email" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.email ? requestScope.insertStudentDTO.email : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="street" name="street" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.street ? requestScope.insertStudentDTO.street : '')}"
                    ...
                    <div>
                        ...
                        <input id="streetNum" name="streetNum" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.streetNum ? requestScope.insertStudentDTO.streetNum : '')}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input id="zipcode" name="zipcode" type="text"
                               value="${fn:escapeXml(not empty requestScope.insertStudentDTO.zipCode ? requestScope.insertStudentDTO.zipCode : '')}"
                    ...
                    <div>
                        ...
                        <select id="cityId" name="cityId"
                            ...
                            <option value="" disabled ${empty requestScope.insertStudentDTO.cityId ? 'selected' : ''}>
                                Επιλέξτε Πόλη
                            </option>
                            <c:forEach items="${requestScope.cities}" var="city">
                                <option value="${city.id}"
                                        ${city.id eq requestScope.insertStudentDTO.cityId ? 'selected' : ''}>
